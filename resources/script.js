    ...
    let downloadHTML = `<li class="row">
                            <div class="content upload">
                              ...
                              <div class="details">
                                ...
                                <span class="size">${formatBytes(parseFloat(compSize.toLocaleString().replace(/,/g, "")))}<a href="${objectURL}" download=${img.name} style='text-decoration: none; cursor: url("hand.png"), auto;' class='text-success ms-3'>Click to download</a></span>
                              </div>
                            </div>
                            <i class="fas fa-check"></i>
                          </li>`;
